...
def getCsvFileNames():
    ...
    list_of_files = glob.glob('C:/Users/Manuel Gomes/Desktop/Dissertação Code/TratamentoLocationDataComplete/Fingerprint 18 Jan/AllData/*.csv') # * means all if need specific format then *.csv
    names=[]
