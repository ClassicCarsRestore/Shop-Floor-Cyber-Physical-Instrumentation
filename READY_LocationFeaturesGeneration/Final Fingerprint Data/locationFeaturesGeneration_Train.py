...
#Obtem todos os nomes dos ficheiros csv com RAW DATA dos beacons
def getCsvFileNames():
    list_of_files = glob.glob('C:/Users/Manuel Gomes/Desktop/Dissertação Code/TratamentoLocationDataComplete/Fingerprint 18 Jan/*.csv') # * means all if need specific format then *.csv
    names=[]
