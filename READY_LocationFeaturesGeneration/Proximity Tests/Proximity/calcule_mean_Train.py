...
def getCsvFileNames():
    list_of_files = glob.glob('C:/Users/Manuel Gomes/Desktop/Dissertação Code/TratamentoLocationDataComplete/Proximity/Lixamento_abc.csv') # * means all if need specific format then *.csv
    names=[]
    print(list_of_files)
...
if __name__ == "__main__":
    ...
    rssiOutputFile="rssiValuesTrain3.csv"
