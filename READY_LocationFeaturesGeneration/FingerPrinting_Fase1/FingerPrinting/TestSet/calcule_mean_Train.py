...
def getCsvFileNames():
    ...
    list_of_files = glob.glob('C:/Users/Manuel Gomes/Desktop/Dissertação Code/TratamentoLocationDataComplete/FingerPrinting/Testset/*.csv') # * means all if need specific format then *.csv
    names=[]
...
if __name__ == "__main__":
    ...
    rssiOutputFile="rssiValuesTest_com31_2.csv"
