...
header = ['position','7eb3bed60a67f44d','fc337481622c4dc8','4b528a07c6810670','de81d543721249f6','9fcccaab3f956f66','a58db253434c6759','4af6994df3a900b9','9a97a9cd9ac398de','b4c8c0b52049e4de']
...
def getCsvFileNames():
    list_of_files = glob.glob('C:/Users/Manuel Gomes/Desktop/Dissertação Code/ProductionLocationWorkshopShopData/All4DbmData/TestFiles/*.csv') # * means all if need specific format then *.csv
    names=[]
