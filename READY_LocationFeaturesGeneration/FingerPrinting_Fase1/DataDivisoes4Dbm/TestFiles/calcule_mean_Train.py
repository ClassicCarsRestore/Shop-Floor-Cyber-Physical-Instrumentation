...
def getCsvFileNames():
    list_of_files = glob.glob('C:/Users/Manuel Gomes/Desktop/Dissertação Code/ProductionLocationWorkshopShopData/DataDivisoes4Dbm/TestFiles/*.csv') # * means all if need specific format then *.csv
    names=[]
