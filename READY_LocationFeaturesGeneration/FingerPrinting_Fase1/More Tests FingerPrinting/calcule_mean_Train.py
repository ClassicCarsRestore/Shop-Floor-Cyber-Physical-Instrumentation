...
def getCsvFileNames():
    ...
    list_of_files = glob.glob('C:/Users/Manuel Gomes/Desktop/Dissertação Code/More Tests Fingerprinting/*.csv') # * means all if need specific format then *.csv
    names=[]
...
if __name__ == "__main__":
    ...
    rssiOutputFile="rssiValuesTest2.csv"
